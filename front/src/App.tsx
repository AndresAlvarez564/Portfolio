  ...
  return (
    <AntApp>
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            {/* Public routes — wrapped in dark design layout */}
            <Route element={<PublicLayout />}>
              ...
              <Route path={ROUTES.SKILLS} element={<Navigate to={ROUTES.HOME} replace />} />
              <Route path={ROUTES.EXPERIENCE} element={<Navigate to={ROUTES.HOME} replace />} />
            ...
            <Route
              ...
              element={<ProtectedRoute><AdminExperiencePage /></ProtectedRoute>}
            />
            <Route
            ...
            <Route
              ...
              element={<ProtectedRoute><AdminCertificationsPage /></ProtectedRoute>}
            />
            <Route
